...
TagNum=[2,3,4]; % The number of collision sources
Tag=TagNum(3); % Select the number of Tags  % TagNum(1) is 2 collision tags
if Tag==2
fi_1 = fopen('measured data\source_2tags','rb'); % 2 collision tags
elseif Tag==3
fi_1 = fopen('measured data\source_3tags','rb'); % 3 collision tags
elseif Tag==4
fi_1 = fopen('measured data\source_4tags','rb'); % 4 collision tags
end
x=measured_dataOutput(fi_1,Tag);% need to choose the tag number in function:"realdataOutput"
